...
-   Programmable API return codes for comparison with connect trigger states, connected states and charging states supported by your EV or charger specific API.
